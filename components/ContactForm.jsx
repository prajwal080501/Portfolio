    ...
    return (
        ...
        >
            ...
            <div className="flex flex-row pt-4 justify-center space-x-4">
                <a href="mailto:iamprajwalladkat@gmail.com" className="flex items-center space-x-2 text-white bg-blue-500 px-3 py-2 rounded-lg duration-200 ease-linear hover:scale-110  font-semibold text-lg">
                ...
                <a href="tel:+919922334455" className="flex items-center space-x-2 text-white font-semibold bg-blue-500 px-3 py-2 hover:scale-110 duration-200 ease-linear rounded-lg text-lg">
            ...
            <button
                type="submit"
                className="py-2 px-4 rounded-lg shadow-md bg-blue-600/80 hover:bg-gradient-to-r hover:from-blue-700 hover:to-fuchsia-500 active:scale-95 drop-shadow-2xl duration-200 ease-linear text-white font-bold w-full md:w-1/3"
            >
                Send Message
            </button>
        </motion.form>
